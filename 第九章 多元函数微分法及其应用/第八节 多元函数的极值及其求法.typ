...
#let problems = (
  ...
  (
    ...
    solution: [
      先求驻点： \
      $f_x=(6-2x)(4y-y^2)=0$，$f_y=(6x-x^2)(4-2y)=0$， \
      解得 $(3,2)$、$(3,0)$、$(3,4)$、$(0,2)$、$(6,2)$、$(0,0)$、$(0,4)$、$(6,0)$、$(6,4)$。 \
      二阶偏导为 \
      $A=f_(x x)=-2(4y-y^2), B=f_(x y)=(6-2x)(4-2y), C=f_(y y)=-2(6x-x^2)$。 \
      在 $(3,2)$ 处 \
      $A=-8, B=0, C=-18$，$A C-B^2=144>0$ 且 $A<0$， \
      故 $(3,2)$ 为极大值点，极大值 \
      $f(3,2)=(18-9)(8-4)=36$。 \
      在 $(0,0)$、$(0,4)$、$(6,0)$、$(6,4)$ 处 $A C-B^2<0$，不是极值点； \
      在 $(3,0)$、$(3,4)$、$(0,2)$、$(6,2)$ 处 $A C-B^2=0$，但函数值在这些点的任一邻域内变号 \
      （例如在 $(3,0)$ 处 $f(3,y)=9(4y-y^2)$ 在 $y=0$ 两侧异号），也不是极值点。 \
      故所求极值为极大值 $f(3,2)=36$，无极小值。
    ],
  ),
  (
    kind: "compute",
