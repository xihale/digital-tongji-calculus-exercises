...
#subsection[一、选择题]
1. 关于微分方程  $(d^2 y)/(d x^2 + 2(d y)/(d x) + y = e^x)$  的下列结论：① 该方程是齐次微分方程，② 该方程是线性微分方程，③ 该方程是常系数微分方程，④ 该方程为二阶微分方程，其中正确的是(#h(2em)).
   #choices(
   [①②③],
   [①②④],
   [①③④],
...
#subsection[二、填空题]
3.  $x y'' + 2x^2(y')^2 + x^3y = x^4 + 1$  是 #blank() 阶微分方程

4. 微分方程  $y' = 2y/x$  的通解为 #blank()
#subsection[三、计算题]
