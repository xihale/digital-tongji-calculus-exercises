...
6. 求下列极限：
  ...
  #answer-process[
    ...
    分子：$e^(3x) - e^(2x) - e^x + 1 = e^(2x)(e^x - 1) - (e^x - 1)$
    
    $= (e^(2x) - 1)(e^x - 1) ~ 2x dot x = 2x^2$
    
    分母：$root(3, (1-x)(1+x)) - 1 = root(3, 1-x^2) - 1$
    
    利用等价无穷小 $(1+u)^(1/3) - 1 ~ u/3$（当 $u -> 0$）
    
    令 $u = -x^2$，则 $root(3, 1-x^2) - 1 ~ (-x^2)/3$
