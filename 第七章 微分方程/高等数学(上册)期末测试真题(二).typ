...
11.  $lim_(x->0^+)(1 + sin x)^(ln x) = #blank[需补充答案]$  
12. 若  $lim_(h->0)(f(1 - 2h) - f(1))/h = 6$ ，则  $f'(1) = \_$ #blank[需补充答案]
13.  $integral_(-1)^(1)(x^2 + sqrt(4 - x^2) bullet sin x) dif x =$ #blank[需补充答案]
14. 设参数方程  $cases( x = f(t) - pi, y = f(e^(2t) - 1), )$  函数  $f$  可导，且  $f'(0) != 0$ ，则  $(d y)/(d x|_(t=0) =)$  #blank[需补充答案].  
15. 曲线  $y = -3/2 x^3 + 9/2 x^2$  在其拐点处的切线方程是 #blank[需补充答案]
16. 微分方程  $y' = 1/(x + y)$  的通解为 #blank[需补充答案]
