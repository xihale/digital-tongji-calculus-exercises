...
1. 设函数  $y = (1 + x)^(1/x)$ ，则  $y'(1) =$ (#answer-choice[D]).
   ...
   #answer-process[
     ...
     $y'(1) = 2[-ln 2/1 + 1/(1 times 2)] = 2[-ln 2 + 1/2] = 2(1/2 - ln 2) = 1 - 2ln 2$
     
     因为 $ln 4 = ln 2^2 = 2 ln 2$，所以 $y'(1) = 1 - ln 4$。
   ]
   
2. 已知曲线  $L$  的参数方程为  $cases( x = 2(t - sin t), y = 2(1 - cos t), )$  则  $L$  上点  $t = pi/2$  处的切线方程是 (#answer-choice[B]).
   #choices(
   [$x + y = pi$],
   [$x - y = pi - 4$],
   [$x - y = pi$],
