...
5. 设  $f'(x) = g(x)$ ，则  $d/d x f(sin^2 x) = (quad)$ .
   #v(0.5em)
   #choices(
   2g(x) sin x$",
   g(x) sin 2x$",
...
14.  $integral_(-infinity)^(+infinity)(dif x)/(x^2 + 2x + 2) = underline(quad)$  
15.  $integral_(-1)^(1)(2x^2 + x sin^2 x)/(1 + sqrt(1 - x^2)) dif x = underline(quad)$  
