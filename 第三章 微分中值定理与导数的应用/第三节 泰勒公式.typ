...
3. 求函数  $f(x) = sqrt(x)$  按  $(x - 4)$  的幂展开的带有拉格朗日余项的三阶泰勒公式
   #answer-process[
     ...
     $f'''(x) = 3/(8x^(5/2)), f'''(4) = 3/256$
      ...
      其中 $R_3(x) = -15/(192 xi^(7/2)) (x-4)^4$ ($4 < xi < x$)
   ]
...
5. 求函数  $f(x) = x e^x$  带有佩亚诺余项的  $n$  阶麦克劳林公式
   #answer-process[
     ...
     $x e^x = x sum_(k=0)^(oo) x^k / k! = sum_(k=0)^(oo) x^(k+1) / k! = sum_(k=1)^(oo) x^k / (k-1)!$
 ...
 6. 应用三阶泰勒公式求  $root(3,30)$  的近似值，并估计误差
    #answer-process[
      ...
      $f'''(27) = 10/(27 times 27^(8/3)) = 10/(27 times 729) = 10/19683 = 10/19683$
      
      $f(30) approx 3 + 1/27 (3) - 2/(2 times 2187) times 9 + 10/6 times 19683 times 27 = 3 + 1/9 - 1/243 + 5/243 approx 3.112$
      
      误差估计：$|R_2| = |f^(3)(xi)| / 6 times 27 < 10/19683 times 27/6 = 5/2187 approx 0.0023$
    ]
...
7. (附加题)利用泰勒公式求下列极限：\
   ...
   (2)  $lim_(x->oo)[x - x^2 ln (1 + 1/x)]$.
   #answer-process[
     令 $t = 1/x$，当 $x -> oo$ 时 $t -> 0^+$
